...
import sgu.atbmhttt.cipherapp.models.SubstitutionCipher;
...
public class SubstitutionCipherController implements Initializable {
    ...
    public void maHoa() {
        try {
            ...
            String bangMa = SubstitutionCipher.encrypt(bangRo, khoaDich);
    ...
    public void giaiMa() {
        try {
            ...
            String bangRo = SubstitutionCipher.decrypt(bangMa, khoaDich);
